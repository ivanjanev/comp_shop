    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="images/caroAsus1.jpg" alt="Asus ROG"  height="100%" width="100%">
            </div>

            <div class="item">
                <img src="images/caroAlienware1.jpg" alt="Alienware" height="100%" width="100%">
            </div>

            <div class="item">
                <img src="images/caroRazor1.jpg" alt="Razor"  height="100%" width="100%">
            </div>
        </div>
